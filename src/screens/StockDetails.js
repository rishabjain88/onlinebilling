...
function Item({Barcode1,ProductName1,Quantity,ReorderQuantity,Price}){
 ...
 setflag(false);
fetch("http://4edd4fc23958.ngrok.io/product",{
...
fetch("http://4edd4fc23958.ngrok.io/productReorder",{
...
allert();
  fetch("http://4edd4fc23958.ngrok.io/delete",{
  ...
  .then((data)=>{ 
    console.log(data)
    alert(data.ProductName+" Deleted!")
  })
}
const reorder=()=>{
  if(flag)
...
const search=()=>{
  ...
  setflag(false);
  setflag2(false);
  fetch("http://4edd4fc23958.ngrok.io/search",{
